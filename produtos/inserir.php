...
<section class="mb-4 border rounded-3 p-4 border-primary-subtle">
    ...
    <form action="" method="post" class="w-75 mx-auto">
        ...
        <div class="form-group">
            ...
            <label for="fornecedor" class="form-label mt-2">Fornecedor: </label>
        ...
        <div class="form-group">
            ...
            <label for="detalhes" class="form-label mt-2">Dimensões: </label>
            <input type="text" class="form-control" id="dimensoes" name="dimensoes">
            <label for="detalhes" class="form-label mt-2">Código de Barras: </label>
