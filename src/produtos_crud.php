...
function inserirProduto(PDO $conexao, array $produto): void{
    ...
    $query->bindValue(":fornecedor_id", $produto['fornecedor'], PDO::PARAM_INT);
...
function inserirDetalhesDoProduto(PDO $conexao, array $detalhes):void {
    ...
    $sql = "INSERT INTO detalhes_produtos(produto_id, peso, dimensoes, codigo_barras, data_validade)
